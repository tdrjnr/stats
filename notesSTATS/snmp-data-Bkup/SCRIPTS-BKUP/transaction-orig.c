...
void main(void)
{
 ...
 // Compute value
  Total_Data_Kbytes_hr = (Total_Trans_hr * Size_Trans) / 1000;
 
 // Compute value
  Total_Data_Kbits_hr = Total_Data_Kbytes_hr * 8 / 1000;
 ...
 // Compute value
  Growth_Total_Data_Kbytes_hr = (Growth_Total_Data_Trans_hr * Size_Trans) / 1000;

 // Compute value
  Growth_Total_Data_Kbits_hr = Growth_Total_Data_Kbytes_hr * 8 / 1000;
