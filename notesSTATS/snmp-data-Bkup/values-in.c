...
#define MIN_VALUE_THRESHOLD     9800 		// Minimum value of notch  KbitsPerSec
#define MAX_VALUE_THRESHOLD     9800	    	// Maximum value of notch KbitsPerSec
...
void main(void)
{
  ...
  printf("  Filter out INBOUND Traffic for THRESHOLD = 70 perc and MAX_VALUE_THRESHOLD = 70 perc \n",
