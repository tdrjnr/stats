...
#define MIN_VALUE_THRESHOLD     	15400     // Minimum value of notch
#define MAX_VALUE_THRESHOLD     	15400     // Maximum value of notch
...
void main(void)
{
  ...
  printf("  Filter out for MIN_VALUE_THRESHOLD = 70%=15400 Kbits and MAX_VALUE_THRESHOLD = 70%=15400 Kbits \n",
