...
** Subject: new version of TQLRAT
*      parameter (n=9)
*      double precision a(n,n),w(n),z(n,n),fv1(n),fv2(n),s,e
*      double precision aa(n,n),ans(n),epslon
*c
*      data aa/-1.d0, 1.d0, 1.d0,-1.d0,-1.d0, 1.d0, 1.d0,-1.d0,-1.d0,
...
*     >        -1.d0, 1.d0, 1.d0,-1.d0,-1.d0, 1.d0,-1.d0, 1.d0, 1.d0/
*c
*      data ans /-6.0d0, -2.6418101226535534d0, -0.6002300187239806d0,
*     >           0.0d0, 0.0d0, 0.0d0, 0.0d0,
*     >           2.7618014800219586d0, 5.4802386613555754d0/
*c
*   10 write(6,*) 'Enter s'
*      read(5,*,end=99) s
*      do 15 i = 1, n
...
*         a(i,j) = s*aa(i,j)
*   15 continue
*      call rs(n,n,a,w,0,z,fv1,fv2,ierr)
*      if (s .eq. 0.0d0) s = 1.0d0
*      e = 0.0d0
*      do 20 i = 1, n
*         w(i) = w(i)/s
*         e = e + dabs(w(i) - ans(i))
