...
c
c     data mcheps(1) / z3CB0000000000000 /
c     data minmag(1) / z0000000000000001 /
c     data maxmag(1) / z7FEFFFFFFFFFFFFF /
c
c     Machine constants for the Sun Sparc 1
c
      data mcheps(1) / Z'3CB0000000000000' /
      data minmag(1) / Z'0000000000000001' /
      data maxmag(1) / Z'7FEFFFFFFFFFFFFA' /
c
      dpmpar = dmach(i)
      return
c
