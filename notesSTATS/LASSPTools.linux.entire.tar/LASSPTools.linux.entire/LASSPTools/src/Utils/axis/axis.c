...
*  Jun 83 - added SLAC UGS whistles and bells.				*
*	John Richardson and Bob Pearson					*
*  Jun 84 - added new string formats and change options	from input data	*
*	Doug Toussaint							*
*  Dec 87 - various.							*
*	Dan Sullivan (DS)						*
*  Oct 89 - added comment (##) capability.				*
*	Dan Sullivan (DS)						*
*  Dec 89 - allow different tick styles, force solid lines for symbols,	*
*           make numbers and clipping optional.				*
*	Steve Langer (SAL)						*
*									*
...
/* Changed "labs" to "labels" so that malloc.h, which includes stdlib.h,
   doesn't conflict with long absolute value: JPSethna 5-31-95 */
