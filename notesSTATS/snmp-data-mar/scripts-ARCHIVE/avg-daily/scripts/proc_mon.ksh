...
#
# PURPOSE: This script is used to monitor the process specified by ARG1
# 	if a single command line argument is used. There is also a "verbose"
#       mode where the monitored process is displayed and ARG2 is monitored.
#
...
# REV. LIST:
#
#	02/22/2001 - Added code for a "verbose" mode to output the results of
#	the 'ps -ef' command.  The verbose mode is set using a "-v" switch.
#
...
# Parse through the commnad line arguments and see if verbose
