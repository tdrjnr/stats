...
# to execute the proper command syntax.  This will alway return
# the OS in UPPERCASE

typeset -u OS   # Use the UPPERCASE valuse for the OS varaible
                ...
                then
                   ...
                   then
                      ...
                      then
                       ...
                       echo "size of the filesystem measured Megabytes\n"
                   fi
                else
