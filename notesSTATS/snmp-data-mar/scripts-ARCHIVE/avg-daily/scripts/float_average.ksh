...
# REV: 1.1.P
#
# PURPOSE: This shell script is used to average a list of numbers.
#          The numbers can be either integers or floating-
...
# input to the bc command. The average of the numbers is
# assigned to the AVERAGE variable.
