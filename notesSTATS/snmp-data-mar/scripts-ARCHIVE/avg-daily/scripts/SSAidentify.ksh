...
HACMP environment because ALL DEFINED, the default action, will turn on/off all
of the SSA drive lights even if the SSA disk is in a volume group that is not
...
# Alway use the UPPERCASED value for the $STATE, $MODE,
