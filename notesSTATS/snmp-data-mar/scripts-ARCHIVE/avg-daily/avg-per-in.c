...
void main(void)
{
  ...
  printf("    Minimum  = %f (position IN = %ld) ", min, minpos); printf(" = %f %\n", min_util);
  printf("    Maximum  = %f (position IN = %ld) ", max, maxpos); printf(" = %f %\n", max_util);
  printf("    Range    = %f \n", range);
  printf("    Total = %f \n", sum);
  printf("    Mean IN   = %f ", mean); printf(" = %f %\n", mean_util);
  printf("    Variance = %f \n", var);
  printf("    Std Dev  = %f \n", stddev);
  printf("    CoV      = %f \n", cov);
  printf("    95%% value IN = %f ", percent_95); printf(" = %f %\n", percent_95_util);
  printf("---------------------------------------------------------------\n");
}
