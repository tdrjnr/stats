...
csv_file='crbsg-colchester-1Mbit.csv'
file='rawdata'
graph='gnuplot-data.txt'
awk="/bin/awk"

summary_file="colchester-VPN.txt"
...
sample1="0[4-7]-01-2005"
sample2="1[0-4]-01-2005"
sample3="19-01-2005"
sample4="2[0-1]-01-2005"
sample5="2[4-8]-01-2005"
sample6="31-01-2005"
sample7="0[2-4]-02-2005"
sample8="0[7-9]-02-2005"
sample9="1[0-1]-02-2005"
sample10="1[4-5]-02-2005"
...
$awk '{ print $'$f1',$'$f2',$'$f3',$'$f4',$'$f5',$'$f6' }' | \
egrep -e $sample1 -e $sample2 -e $sample3 -e $sample4 -e $sample5 -e $sample6 -e $sample7 -e $sample8 -e $sample9 -e $sample10 | \
$awk $time > $csv_file.$sample_period.$sample_time.$sample_days.$file
}
...
sleep 1.5
awk '{ print $3, $4 }' $csv_file.$sample_period.$sample_time.$sample_days.$file > $summary_file.$sample_period.$sample_time.$sample_days.stats; 
}
